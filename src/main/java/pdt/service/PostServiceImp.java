...
public class PostServiceImp implements PostService {
	...
	public void updatePost(Post post) {
		...
		findPost.setText(findPost.getText());
		findPost.setKeyword(findPost.getKeyword());
		findPost.setKeyword1(findPost.getKeyword1());
		findPost.setKeyword2(findPost.getKeyword2());
		findPost.setKeyword3(findPost.getKeyword3());
	...
	public List<PostDTO> getPostListWithUserId(String userId) {
		...
		List<Post> postList = postRepo.getPostListWithUserId(userId);
		List<PostDTO> postListDTO = postList.stream().map(post -> modelMapper.map(post, PostDTO.class))
				.collect(Collectors.toList());
