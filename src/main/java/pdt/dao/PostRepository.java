...
public interface PostRepository extends JpaRepository<Post, Long> {
	...
	public List<Post> getPostListWithUserId(@Param("id") String userId);
...
//	public Long returnLike(@Param("id") Long postId);
	...
	@Query(value = "select(A.keyword1), count(*) as count from ((select keyword1 from post union all select keyword2 from post) union all select keyword3 from post) A group by A.keyword1 ordery by A.keyword1 limit 5;", nativeQuery = true)
